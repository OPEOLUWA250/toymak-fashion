              ...
              <div className="flex items-center justify-between gap-4 xl:justify-start">
                <div>
                  ...
                  <p className="mt-1 text-sm text-neutral-500">
                    A responsive control center for sales, stock, and
                    fulfillment.
                  </p>
                </div>
                  ...
                  <div className="rounded-[1.75rem] border border-neutral-200 bg-white p-5 shadow-[0_18px_50px_-35px_rgba(0,0,0,0.28)] lg:p-6">
                    <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                      <div>
                        ...
                        <p className="text-sm text-neutral-500">
                          Live order queue and payment status
                        </p>
                      </div>
                    ...
                    <div className="mt-4 flex items-center justify-between text-sm text-neutral-500">
                      ...
                      <div className="flex items-center gap-2">
                        <button className="rounded-lg border border-neutral-200 px-3 py-2">
                          1
                        </button>
                        <button className="rounded-lg border border-primary bg-primary px-3 py-2 text-white">
                          2
                        </button>
                        <button className="rounded-lg border border-neutral-200 px-3 py-2">
                          3
                      ...
                      >
                        ...
                        <div className="mt-4 h-2 overflow-hidden rounded-full bg-neutral-100">
                          <div
                            ...
                            style={{
                              width: `${Math.min((product.stock_qty / 200) * 100, 100)}%`,
                            }}
                          />
                        </div>
                  ...
                  <div className="rounded-[1.75rem] border border-neutral-200 bg-neutral-950 p-5 text-white shadow-[0_18px_50px_-35px_rgba(0,0,0,0.35)]">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div className="rounded-2xl bg-white/10 p-4">
                        ...
                        <p className="mt-1 text-2xl font-semibold">
                          {insights.featuredProducts.length}
                        </p>
                      </div>
                    </div>
                    <p className="mt-4 text-sm leading-6 text-white/75">
                      Keep the dashboard clean and decisive. The storefront and
                      admin now speak the same design language.
                    </p>
                  </div>
                </aside>
              </div>
